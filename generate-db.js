// Generate complete OS database with 2500+ entries
const fs = require('fs');
...
const windows11Eds = ['Home', 'Pro', 'Education', 'Enterprise', 'IoT Enterprise'];
const windows10Eds = ['Home', 'Pro', 'Education', 'Enterprise', 'LTSC 2021', 'IoT Enterprise LTSC'];
const windows7Eds = ['Home Basic', 'Home Premium', 'Professional', 'Ultimate', 'Enterprise', 'Starter'];
...
const linuxDistros = [
  {
    ...
    editions: ['Desktop', 'Server', 'Server ARM'],
    archs: { 'Desktop': '64-bit', 'Server': '64-bit', 'Server ARM': 'arm64' },
    urls: { 'Desktop': 'https://releases.ubuntu.com/', 'Server': 'https://releases.ubuntu.com/', 'Server ARM': 'https://releases.ubuntu.com/' },
    baseSize: 4.7
  },
  {
    family: 'Debian',
    ...
    editions: ['Desktop', 'Netinst', 'Server'],
    archs: { 'Desktop': '64-bit', 'Netinst': '64-bit', 'Server': '64-bit' },
    urls: { 'Desktop': 'https://cdimage.debian.org/', 'Netinst': 'https://cdimage.debian.org/', 'Server': 'https://cdimage.debian.org/' },
    baseSize: 3.8
  },
  {
    family: 'Fedora',
    ...
    editions: ['Workstation', 'Server', 'KDE', 'XFCE'],
    archs: { 'Workstation': '64-bit', 'Server': '64-bit', 'KDE': '64-bit', 'XFCE': '64-bit' },
    urls: { 'Workstation': 'https://fedoraproject.org/', 'Server': 'https://fedoraproject.org/', 'KDE': 'https://fedoraproject.org/', 'XFCE': 'https://fedoraproject.org/' },
    baseSize: 4.2
  },
  {
    family: 'Linux Mint',
    ...
    archs: { 'Cinnamon': '64-bit', 'MATE': '64-bit', 'XFCE': '64-bit' },
    urls: { 'Cinnamon': 'https://linuxmint.com/', 'MATE': 'https://linuxmint.com/', 'XFCE': 'https://linuxmint.com/' },
    baseSize: 4.0
  },
  {
    family: 'Pop!_OS',
    ...
    editions: ['Desktop', 'NVIDIA'],
    archs: { 'Desktop': '64-bit', 'NVIDIA': '64-bit' },
    urls: { 'Desktop': 'https://pop.system76.com/', 'NVIDIA': 'https://pop.system76.com/' },
    baseSize: 4.5
  },
  {
    family: 'Arch Linux',
  ...
  },
  {
    ...
    editions: ['KDE', 'GNOME', 'XFCE'],
    archs: { 'KDE': '64-bit', 'GNOME': '64-bit', 'XFCE': '64-bit' },
    urls: { 'KDE': 'https://manjaro.org/', 'GNOME': 'https://manjaro.org/', 'XFCE': 'https://manjaro.org/' },
    baseSize: 4.1
  },
  {
    family: 'Kali Linux',
    ...
    editions: ['Desktop', 'Live', 'NetInstaller'],
    archs: { 'Desktop': '64-bit', 'Live': '64-bit', 'NetInstaller': '64-bit' },
    urls: { 'Desktop': 'https://www.kali.org/', 'Live': 'https://www.kali.org/', 'NetInstaller': 'https://www.kali.org/' },
    baseSize: 4.8
  },
  {
    family: 'openSUSE',
    ...
    editions: ['Desktop', 'DVD', 'Net'],
    archs: { 'Desktop': '64-bit', 'DVD': '64-bit', 'Net': '64-bit' },
    urls: { 'Desktop': 'https://www.opensuse.org/', 'DVD': 'https://www.opensuse.org/', 'Net': 'https://www.opensuse.org/' },
    baseSize: 4.6
  },
  {
    family: 'Zorin OS',
    ...
    editions: ['Core', 'Pro', 'Lite'],
    archs: { 'Core': '64-bit', 'Pro': '64-bit', 'Lite': '64-bit' },
    urls: { 'Core': 'https://zorin.com/', 'Pro': 'https://zorin.com/', 'Lite': 'https://zorin.com/' },
    baseSize: 4.3
  },
  {
    family: 'elementary OS',
    versions: [
    ...
    editions: ['Desktop'],
    archs: { 'Desktop': '64-bit' },
    urls: { 'Desktop': 'https://elementary.io/' },
    baseSize: 3.9
  },
  {
    family: 'Rocky Linux',
    ...
    archs: { 'Minimal': '64-bit', 'DVD': '64-bit', 'Boot': '64-bit' },
    urls: { 'Minimal': 'https://rockylinux.org/', 'DVD': 'https://rockylinux.org/', 'Boot': 'https://rockylinux.org/' },
    baseSize: 4.4
  },
  {
    family: 'AlmaLinux',
    ...
    editions: ['Minimal', 'DVD', 'Boot'],
    archs: { 'Minimal': '64-bit', 'DVD': '64-bit', 'Boot': '64-bit' },
    urls: { 'Minimal': 'https://almalinux.org/', 'DVD': 'https://almalinux.org/', 'Boot': 'https://almalinux.org/' },
    baseSize: 4.4
  },
  {
    ...
    archs: { 'Minimal': '64-bit', 'DVD': '64-bit' },
    urls: { 'Minimal': 'https://www.centos.org/', 'DVD': 'https://www.centos.org/' },
    baseSize: 4.2
  },
  {
    family: 'Tails',
  ...
  },
  {
    ...
    editions: ['Gateway', 'Workstation'],
    archs: { 'Gateway': '64-bit', 'Workstation': '64-bit' },
    urls: { 'Gateway': 'https://www.whonix.org/', 'Workstation': 'https://www.whonix.org/' },
    baseSize: 2.0
  },
  {
    family: 'Parrot OS',
    ...
    archs: { 'Security': '64-bit', 'Home': '64-bit' },
    urls: { 'Security': 'https://www.parrotsec.org/', 'Home': 'https://www.parrotsec.org/' },
    baseSize: 4.5
  }
];

const linuxLangs = ['English'];
for (const distro of linuxDistros) {
  for (const v of distro.versions) {
    for (const ed of distro.editions) {
      for (const l of linuxLangs) {
        const arch = distro.archs[ed] || '64-bit';
        const url = distro.urls[ed] || 'https://www.linux.org/';
        addEntry(2, distro.family, v.ver, v.codename, arch, distro.baseSize, v.desc, v.date, v.eos, v.lts, v.sup, l, ed, url);
      }
    }
  }
}
...
-- Usage: Copy to db.sql or sqlite3 db.db < this_file.sql
...
// Split entries into batches for SQL INSERT statements
...
sql += `-- =============================================================================
-- COMPLETE: ${entries.length} total entries
